...
import {blockPercent, difficultyMeta, groupFor, metricDomId, percent, scoreFor} from '../../domain/report.js';

export {blockPercent, difficultyMeta, groupFor, metricDomId, percent, scoreFor};
...
export const TEAM_CONTACT_EMAIL = 'MYCherkova@sberbank.ru';
