export const DD_SCENARIO_RECOMMENDATIONS = [
  {
    ...
    sourceTool: 'Bootcamp',
    recommendation: 'Рекомендуем согласовать с HR-партнёром участие аналитиков в AI Bootcamp и закрепить практический кейс команды как результат обучения.',
  },
  {
  ...
  },
  {
    ...
    sourceTool: 'ФьючерСторе',
    recommendation: 'Рекомендуем оформлять согласованные методологии как переиспользуемые артефакты во ФьючерСторе и назначать владельца актуальности.',
  },
  {
  ...
  {
    key: 'exports_to_excel_regulator',
    direction: 'Выгрузка',
    scenario: 'Выгрузки для регулятора',
    info: 'Подготовка и экспорт данных в регламентированной форме для надзорных органов или внешних внебанковских контрагентов (аудиторы, рейтинговые агентства, страховщики)',
    sourceTool: '-',
    recommendation: 'Рекомендуем зафиксировать единый шаблон, владельца и контрольный чек-лист регуляторной выгрузки; автоматизацию запускать только после согласования требований.',
  },
  {
    key: 'data_marts',
  ...
  },
  {
    ...
    scenario: 'Ручной ККД',
    info: 'Ручной контроль качества данных, сверка, исправление ошибок в данных вручную.',
    sourceTool: 'Контроль дашбордов в Навигаторе',
    recommendation: 'Рекомендуем использовать дашборд Навигатора как контрольную точку и составить план автоматизации наиболее частых ручных проверок.',
    resources: [{label: 'ссылке', href: 'https://navigator.sigma.sbrf.ru/gdash/1000004439/1000039256'}],
  },
  {
  ...
  },
  {
    ...
    sourceTool: '',
    recommendation: 'Рекомендуем сделать обязательными в тикете ожидаемый результат, источник данных, потребителя и критерий готовности, а неполные задачи возвращать автору.',
  },
  {
