...
function MetricRow({block, metric, product, detailScore, maxIndexPoints, instruction, instructionLinks = [], library, zeroAction, aiMetricInsight, aiMetricInsights = [], skillActions = [], grouped, digitallyConfirmed, crossSellUnconfirmed, highlighted}) {
