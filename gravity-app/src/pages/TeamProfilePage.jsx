  ...
  return <Dialog open onClose={onClose} hasCloseButton maxWidth="m" fullWidth contentOverflow="auto">
    ...
    <Dialog.Body>
      <div className="crosssell-preview-dialog">
        <RecommendationBody item={preview.recommendation} />
...
function CxHelpContent({audience}) {
  ...
  return <div className="goals-help-content"><p>На основе дешборда "CX Score".</p><strong>Оценка:</strong><ul><li><b>1 балл (100%)</b> — зелёная зона CX Score.</li><li><b>0,5 балла (50%)</b> — жёлтая зона CX Score.</li></ul></div>;
}
